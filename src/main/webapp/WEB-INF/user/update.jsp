				...
				<tbody>
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input id="loginname"
							type="text" class="required" name="loginname"
							value="${GETUSER.loginname}" maxlength="100" /> <span
							id="loginnamemsg" /></td>
					</tr>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h"><span
						...
						<td width="80%" class="pn-fcontent"><input id="password"
							...
							value="${GETUSER.password}" maxlength="100" /> <span
							id="passwordmsg" /></td>
					</tr>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h"><span
						...
						<td width="80%" class="pn-fcontent"><input id="conpwd"
							type="password" class="required" name="conpwd"
							value="${GETUSER.password}" maxlength="100" /></td>
					</tr>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h">真实姓名:</td>
						<td width="80%" class="pn-fcontent"><input id="realname"
							type="text" class="required" name="realname"
							value="${GETUSER.realname}" maxlength="100" /> <span
							id="realnamemsg" /></td>
					</tr>
					<c:if test="${GETUSER.sex=='男'}">
						<tr>
							<td width="20%" class="pn-flabel pn-flabel-h">性别:</td>
							<td width="80%" class="pn-fcontent"><input type="radio"
								name="sex" checked value="男" selected="selected" />男 <input
								type="radio" name="sex" value="女" />女</td>
						</tr>
					</c:if>
					
					<c:if test="${GETUSER.sex=='女'}">
						<tr>
							<td width="20%" class="pn-flabel pn-flabel-h">性别:</td>
							<td width="80%" class="pn-fcontent"><input type="radio"
								name="sex" checked value="男"  />男 <input
								type="radio" name="sex" value="女" selected="selected"/>女</td>
						</tr>
					</c:if>
					<c:if test="${GETUSER.sex==''}">
						<tr>
							<td width="20%" class="pn-flabel pn-flabel-h">性别:</td>
							<td width="80%" class="pn-fcontent"><input type="radio"
								name="sex" checked value="男"  />男 <input
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="text"
							...
							onclick="WdatePicker()" readonly="readonly" value="${GETUSER.birthdayTxt}"/></td>
					</tr>

					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h">email:</td>
						<td width="80%" class="pn-fcontent"><input id="email"
							type="text" name="email" maxlength="80" value="${GETUSER.email}"/> <span id="emailmsg" />
						</td>
					</tr>
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="file"
							id="file" name="file" /> <!-- 用于图片回显 --> <img id="picurl"
							width="60px" height="60px" /> <input type="hidden" id="pic"
							name="pic" value="${GETUSER.pic}"/></td>
					</tr>
